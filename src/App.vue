			...
			list: [
				{
					time: "2011-07",
					title: "映智科技股份有限公司設立",
					thumb: require("./assets/overview1.png"),
					thumb_size: "30%",
				},
				{
					time: "2013-04",
					title: "成功推出256×360 pixel size指紋辨識感測IC。",
					thumb: require("./assets/overview2.png"),
					thumb_size: "40%",
				},
				{
					time: "2014-03",
					title: "成功推出160×160 pixel size指紋辨識感測IC。",
					thumb: require("./assets/overview3.png"),
					thumb_size: "40%",
				},
				{
					time: "2014-05",
					title: "成功推出208×288 pixel size指紋辨識感測IC。",
					thumb: require("./assets/overview4.png"),
					thumb_size: "40%",
					offsetTop: "120px"
				},
				{
					...
					thumb: require("./assets/overview5.png"),
					thumb_size: "30%",
				},
				{
					time: "2014-11",
					title: "成功推出第二代160×160 pixel size指紋辨識感測IC，適用於智慧型手持設備。",
					thumb: require("./assets/overview6.png"),
					thumb_size: "40%",
				},
				{
					time: "2015-01",
					title: "成功推出指紋辨識感測IC結合controller之解決方案。",
					thumb: require("./assets/overview7.png"),
					thumb_size: "30%",
				},
				{
					time: "2015-07",
					title: "成功推出指紋辨識感測IC結合安全晶片之解決方案，並獲得工業級平板製造商之採納。",
					thumb: require("./assets/overview8.png"),
					thumb_size: "30%",
					offsetTop: "150px"
				},
				{
					...
					thumb: require("./assets/overview9.png"),
					thumb_size: "30%",
				},
				{
					time: "2016-05",
					title: "成功推出指紋辨識感測IC結合MUC之解決方案，並順利打入電子鎖供應鏈。",
					thumb: require("./assets/overview10.png"),
					thumb_size: "30%",
				},
				{
					time: "2016-09",
					title: "導入瑞典演算法大廠Precise Biometrics AB演算法。",
					thumb: require("./assets/overview11.png"),
					thumb_size: "40%",
					offsetTop: "100px"
				},
				{
					...
					thumb: require("./assets/overview12.png"),
					thumb_size: "40%",
				},
				{
					time: "2017-11",
					title: "SF302系列產品獲得FBI所頒發的PIV（Personal Identity Verification）認證。",
					thumb: require("./assets/overview13.png"),
					thumb_size: "25%",
					offsetTop: "100px"
				},
				{
					...
					thumb: require("./assets/overview14.png"),
					thumb_size: "35%",
				},
				{
					time: "2019-11",
					title: "成功推出玻璃感測技術專用之ASIC IC─iG101。",
					thumb: require("./assets/overview15.png"),
					thumb_size: "25%",
				},
				{
					time: "2020-04",
					title: "成功推出第一顆玻璃感測IC─GF601BD，並獲得FBI所頒發的PIV認證。",
					thumb: require("./assets/overview16.png"),
					thumb_size: "25%",
				},
				{
					time: "2020-07",
				...
				},
				{
					...
					thumb: require("./assets/overview17.png"),
					thumb_size: "40%",
				},
				{
					time: "2020-12",
					title: "正式取得ISO 9001:2015 認證。",
					thumb: require("./assets/overview18.png"),
					thumb_size: "25%",
				},
			],
		}
